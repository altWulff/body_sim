...
class TestBreastRow:
    ...
    def test_current_cup_increases_with_fill(self, breast_row):
        ...
        assert breast_row.current_cup > initial_cup or breast_row.current_cup == CupSize.D
    ...
    def test_start_lactation(self, breast_row):
        ...
        breast_row.lactation.start.assert_called() or \
        breast_row.lactation.activate.assert_called()
    
    def test_stop_lactation(self, breast_row):
        """Тест остановки лактации."""
        breast_row.stop_lactation()
        
        breast_row.lactation.stop.assert_called() or \
        breast_row.lactation.deactivate.assert_called()
    ...
    def test_tick_state_change_event(self, breast_row, event_bus):
        ...
        with patch.object(breast_row, '_determine_state', return_value=BreastState.TENSE):
            with patch.object(breast_row, 'filled', 100.0):
