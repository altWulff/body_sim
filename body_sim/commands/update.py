...
def register_update_commands(registry: CommandRegistry):
    ...
    registry.register(
        "update",
        cmd_update,
        "Update body or component: update [path] [dt]",
        aliases=["u"],
        category="Обновление",
    )
    registry.register(
        "update.reproductive",
        cmd_update_reproductive,
        "Update reproductive system [dt]",
        aliases=["ur"],
        category="Обновление",
    )
    registry.register(
        "update.digestive",
        cmd_update_digestive,
        "Update digestive system [dt]",
        aliases=["ud"],
        category="Обновление",
    )
    registry.register(
        "tick",
        cmd_tick,
        "Quick tick (0.1s * count): tick [count]",
        aliases=["t"],
        category="Обновление",
    )
